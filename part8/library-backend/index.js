...
const resolvers = {
  ...
  Mutation: {
    ...
    editAuthor(root, args) {
      let authorChanged = authors.find(author => author.name == args.name)
      authorChanged.born = args.setBornTo

      if(!authorChanged) {
        return null
      }else {
        authors = authors.map(author => author.name == args.name ? authorChanged : author)
